...
@if($contas->isEmpty())
    <p class="py-4 text-center text-sm text-gray-500 dark:text-gray-400">Nenhum título (conta a pagar) gerado por esta despesa recorrente.</p>
@else
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                        ...
                        <td class="px-3 py-2 text-center">
                            <span class="inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium
                                ...
                                @elseif($c->esta_vencido) bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300
                        ...
                        <td class="px-3 py-2 text-center">
                            <a href="{{ route('financeiro.contas-pagar.edit', $c) }}" class="text-brand-600 hover:text-brand-800 dark:text-brand-400 dark:hover:text-brand-300" title="Abrir conta">Abrir</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
    ...
    @if($contas->count() >= 200)
        <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Exibindo os 200 títulos mais recentes.</p>
    @endif
@endif
