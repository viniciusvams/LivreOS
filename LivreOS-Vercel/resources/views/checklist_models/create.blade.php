...
<div class="mb-6 flex items-center justify-between">
    <div>
        <h1 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">Novo Modelo de Checklist</h1>
        <p class="text-gray-600 dark:text-gray-400">Crie um modelo de checklist para uso nas Ordens de Serviço</p>
    </div>
...
@include('checklist_models._form')
@endsection
