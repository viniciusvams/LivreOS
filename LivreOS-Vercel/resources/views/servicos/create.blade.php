...
<div class="mb-6 flex items-center justify-between">
    <div>
        <h1 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">Novo Serviço</h1>
        <p class="text-gray-600 dark:text-gray-400">Cadastre um serviço prestado</p>
    </div>
