...
@section('content')
@php
    $cpfFormatado = $user->cpf ? preg_replace('/(\d{3})(\d{3})(\d{3})(\d{2})/', '$1.$2.$3-$4', $user->cpf) : '';
    $cpfValue = old('cpf', $cpfFormatado);
    if ($cpfValue && strlen(preg_replace('/\D/', '', $cpfValue)) === 11) {
        $cpfValue = preg_replace('/(\d{3})(\d{3})(\d{3})(\d{2})/', '$1.$2.$3-$4', preg_replace('/\D/', '', $cpfValue));
    }
@endphp
<div class="mb-6">
    <h1 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">Editar Usuário</h1>
    <p class="text-gray-600 dark:text-gray-400">Atualize as informações organizadas em blocos</p>
</div>
...
<div class="rounded-lg border border-gray-200 bg-white p-6 shadow-theme-sm dark:border-gray-800 dark:bg-gray-800" id="form-user-container">
    <form action="{{ route('admin.users.update', $user) }}" method="POST">
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name', $user->name) }}" required class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email', $user->email) }}" required class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                ...
                <div>
                    ...
                    <input type="password" id="password" name="password" class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                    @error('password')<p class="mt-1 text-sm text-error-600 dark:text-error-400">{{ $message }}</p>@enderror
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Deixe em branco para manter a atual</p>
                </div>
                <div>
                    ...
                    <input type="password" id="password_confirmation" name="password_confirmation" class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                </div>
                <div class="md:col-span-2 flex flex-wrap gap-6">
                    <label class="flex items-center gap-2">
                        <input type="checkbox" name="ativo" value="1" {{ old('ativo', $user->ativo ?? true) ? 'checked' : '' }} class="rounded border-gray-300 text-brand-500 focus:ring-brand-500">
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Status: Ativo</span>
                    </label>
                    <label class="flex items-center gap-2">
                        <input type="checkbox" name="is_admin" value="1" {{ old('is_admin', $user->is_admin) ? 'checked' : '' }} class="rounded border-gray-300 text-brand-500 focus:ring-brand-500">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <label class="flex items-center gap-2">
                            <input type="checkbox" name="roles[]" value="{{ $role->id }}" {{ in_array($role->id, old('roles', $user->roles->pluck('id')->toArray())) ? 'checked' : '' }} class="rounded border-gray-300 text-brand-500 focus:ring-brand-500">
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" id="cpf" name="cpf" value="{{ $cpfValue }}" placeholder="000.000.000-00" maxlength="14" class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                ...
                <div>
                    ...
                    <input type="text" id="rg" name="rg" value="{{ old('rg', $user->rg) }}" maxlength="20" class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                ...
                <div>
                    ...
                    <input type="text" id="rg_orgao_emissor" name="rg_orgao_emissor" value="{{ old('rg_orgao_emissor', $user->rg_orgao_emissor) }}" placeholder="Ex: SSP/SP" maxlength="20" class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                ...
                <div>
                    ...
                    <input type="text" id="telefone" name="telefone" value="{{ old('telefone', $user->telefone) }}" placeholder="(00) 00000-0000" maxlength="20" class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                <div>
                    ...
                    <input type="text" id="cargo" name="cargo" value="{{ old('cargo', $user->cargo) }}" placeholder="Ex: Técnico de campo" maxlength="100" class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                ...
                <div>
                    ...
                    <input type="text" id="departamento" name="departamento" value="{{ old('departamento', $user->departamento) }}" maxlength="100" class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                ...
                <div>
                    ...
                    <input type="number" id="custo_hora_tecnica" name="custo_hora_tecnica" value="{{ old('custo_hora_tecnica', $user->custo_hora_tecnica) }}" step="0.01" min="0" placeholder="0,00" class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
        ...
        <div class="mb-8">
            ...
            @php
                $cepValue = old('cep', $user->cep);
                if ($cepValue && strlen(preg_replace('/\D/', '', $cepValue)) === 8) {
                    $cepValue = preg_replace('/(\d{5})(\d{3})/', '$1-$2', preg_replace('/\D/', '', $cepValue));
                }
            @endphp
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                <div class="md:col-span-2 lg:col-span-1">
                    ...
                    <div class="flex gap-2">
                        <input type="text" id="cep" name="cep" value="{{ $cepValue }}" placeholder="00000-000" data-endereco-container="#form-user-container" maxlength="10" class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90" aria-describedby="cep-hint">
                ...
                <div class="md:col-span-2 lg:col-span-3">
                    ...
                    <input type="text" id="logradouro" name="logradouro" value="{{ old('logradouro', $user->logradouro) }}" class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                ...
                <div>
                    ...
                    <input type="text" id="numero" name="numero" value="{{ old('numero', $user->numero) }}" maxlength="20" class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                ...
                <div>
                    ...
                    <input type="text" id="complemento" name="complemento" value="{{ old('complemento', $user->complemento) }}" maxlength="100" class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                ...
                <div>
                    ...
                    <input type="text" id="bairro" name="bairro" value="{{ old('bairro', $user->bairro) }}" maxlength="100" class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                ...
                <div>
                    ...
                    <select id="uf" name="uf" class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                        ...
                        @foreach(['AC','AL','AP','AM','BA','CE','DF','ES','GO','MA','MT','MS','MG','PA','PB','PR','PE','PI','RJ','RN','RS','RO','RR','SC','SP','SE','TO'] as $uf)
                            <option value="{{ $uf }}" {{ old('uf', $user->uf) === $uf ? 'selected' : '' }}>{{ $uf }}</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select id="cidade" name="cidade" data-selected="{{ old('cidade', $user->cidade) }}" class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
        ...
        <?php do_action('admin.users.form.extra', $user); ?>
        @endif

        <div class="flex gap-3 border-t border-gray-200 pt-4 dark:border-gray-700">
            <button type="submit" class="rounded-lg bg-brand-500 px-5 py-2.5 text-sm font-medium text-white hover:bg-brand-600">Atualizar Usuário</button>
