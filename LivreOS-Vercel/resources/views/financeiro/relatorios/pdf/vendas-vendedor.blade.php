...
<body>
    ...
    <p>Inclui recebimentos de OS (rateio por técnico) e de pedidos de venda (vendedor do pedido), por data de recebimento.</p>
    <p>Total: R$ {{ number_format($totalGeral, 2, ',', '.') }}</p>
