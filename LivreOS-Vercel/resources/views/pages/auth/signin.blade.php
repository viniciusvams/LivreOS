    ...
    <div class="relative z-1 bg-white p-6 sm:p-0 dark:bg-gray-900">
        <div class="relative flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
            ...
            <div class="flex min-h-screen w-full flex-1 flex-col lg:w-1/2">
                    ...
                    <div>
                        <div class="mb-6 sm:mb-8">
                            ...
                            <div class="mb-6 flex justify-center sm:justify-start">
                                <span class="flex size-28 items-center justify-center rounded-full bg-white shadow-md sm:size-32">
                                    <img src="{{ $logoSrcForm }}" alt="{{ config('app.name') }}" class="max-h-16 w-auto object-contain sm:max-h-20" />
                                </span>
                            </div>
                            {{-- Título --}}
                            <h1 class="mb-4 text-center text-lg font-semibold text-gray-800 dark:text-white/90 sm:text-left sm:text-xl">
                                Entrar no {{ config('app.name') }}
                            </h1>
                            {{-- Chamadas --}}
                            <p class="mb-4 flex flex-wrap items-center justify-center gap-x-2 text-sm text-gray-600 dark:text-gray-400 sm:justify-start">
                                <span class="font-medium text-brand-600 dark:text-brand-400">Livre</span>
                                <span aria-hidden="true" class="text-gray-400 dark:text-gray-500">|</span>
                                <span class="font-medium text-brand-600 dark:text-brand-400">Sem Mensalidade</span>
                                <span aria-hidden="true" class="text-gray-400 dark:text-gray-500">|</span>
                                <span class="font-medium text-brand-600 dark:text-brand-400">Código Aberto</span>
                            </p>
                            {{-- Instrução --}}
                            <p class="mb-4 text-center text-sm text-gray-500 dark:text-gray-400 sm:text-left">
                        ...
                        <div>
                            <form action="{{ route('login') }}" method="POST">
                                ...
                                @if($errors->any())
                                <div class="mb-4 rounded-lg border border-error-200 bg-error-50 p-3 text-sm text-error-700 dark:border-error-800 dark:bg-error-500/10 dark:text-error-400">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div x-data="{ checkboxToggle: {{ old('remember') ? 'true' : 'false' }} }">
                                            <label for="remember" class="flex cursor-pointer items-center text-sm font-normal text-gray-700 select-none dark:text-gray-400">
                                                <div class="relative">
                                                    <input type="checkbox" id="remember" name="remember" class="sr-only" @change="checkboxToggle = !checkboxToggle" {{ old('remember') ? 'checked' : '' }} />
                            ...
                            <div class="mt-5">
                                <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                    Não tem uma conta?
                                    <a href="/signup" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Cadastrar</a>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                {{-- Rodapé --}}
                <footer class="mx-auto w-full max-w-md border-t border-gray-200 py-4 dark:border-gray-700">
                ...
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        ...
                        <p class="text-center text-gray-400 dark:text-white/60">
                            {{ config('app.name') }} — {{ config('app.tagline', 'ERP Open Source Livre') }}
                        </p>
                    </div>
                </div>
            </div>
