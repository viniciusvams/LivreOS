                            ...
                            <td class="whitespace-nowrap px-4 py-3 text-right">
                                <div class="flex items-center justify-end gap-1">
                                    ...
                                    @if($v->status === 'finalizada' || $v->status === 'cancelada')
                                        <a href="{{ url('/plugin/pdv/api/vendas/' . $v->id . '/comprovante-pdf') }}"
                                            target="_blank"
                                            class="inline-flex items-center rounded p-1.5 text-indigo-600 hover:bg-indigo-50 dark:text-indigo-400 dark:hover:bg-indigo-900/20"
